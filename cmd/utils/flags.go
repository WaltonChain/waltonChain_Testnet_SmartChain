...
import (
	...
	"go-wtc-aux/accounts"
	"go-wtc-aux/accounts/keystore"
	"go-wtc-aux/common"
	"go-wtc-aux/common/fdlimit"
	"go-wtc-aux/consensus"
	"go-wtc-aux/consensus/clique"
	"go-wtc-aux/consensus/ethash"
	"go-wtc-aux/core"
	"go-wtc-aux/core/rawdb"
	"go-wtc-aux/core/vm"
	"go-wtc-aux/crypto"
	"go-wtc-aux/eth"
	"go-wtc-aux/eth/catalyst"
	"go-wtc-aux/eth/downloader"
	"go-wtc-aux/eth/ethconfig"
	"go-wtc-aux/eth/gasprice"
	"go-wtc-aux/eth/tracers"
	"go-wtc-aux/ethdb"
	"go-wtc-aux/ethstats"
	"go-wtc-aux/graphql"
	"go-wtc-aux/internal/ethapi"
	"go-wtc-aux/internal/flags"
	"go-wtc-aux/les"
	"go-wtc-aux/log"
	"go-wtc-aux/metrics"
	"go-wtc-aux/metrics/exp"
	"go-wtc-aux/metrics/influxdb"
	"go-wtc-aux/miner"
	"go-wtc-aux/node"
	"go-wtc-aux/p2p"
	"go-wtc-aux/p2p/enode"
	"go-wtc-aux/p2p/nat"
	"go-wtc-aux/p2p/netutil"
	"go-wtc-aux/params"
...
var (
	...
	MainChainRPCListenAddrFlag = cli.StringFlag{
		Name:  "uniterpcaddr",
		Usage: "The main chain's HTTP-RPC server listening interface",
		Value: ethash.DefaultMainChainRPCHost,
	}
	MainChainRPCPortFlag = cli.IntFlag{
		Name:  "uniterpcport",
		Usage: "The main chain's HTTP-RPC server listening port",
		Value: ethash.DefaultMainChainRPCPort,
	}
...
func setEthash(ctx *cli.Context, cfg *ethconfig.Config) {
	...
	if ctx.GlobalIsSet(MainChainRPCListenAddrFlag.Name) {
		cfg.Ethash.MainChainRPCHost = ctx.GlobalString(MainChainRPCListenAddrFlag.Name)
	}
	if ctx.GlobalIsSet(MainChainRPCPortFlag.Name) {
		cfg.Ethash.MainChainRPCPort = ctx.GlobalInt(MainChainRPCPortFlag.Name)
	}
}
