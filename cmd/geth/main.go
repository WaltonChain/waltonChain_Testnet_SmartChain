...
import (
	...
	"go-wtc-aux/cmd/utils"
	"go-wtc-aux/common"
	"go-wtc-aux/console/prompt"
	"go-wtc-aux/eth"
	"go-wtc-aux/eth/downloader"
	"go-wtc-aux/ethclient"
	"go-wtc-aux/internal/debug"
	...
	_ "go-wtc-aux/eth/tracers/js"
	_ "go-wtc-aux/eth/tracers/native"
...
var (
	...
	nodeFlags = []cli.Flag{
		...
		utils.MainChainRPCListenAddrFlag,
		utils.MainChainRPCPortFlag,
