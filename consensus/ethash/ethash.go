...
const (
	DefaultMainChainRPCHost = "http://localhost" // The default host interface of the main chain's HTTP RPC server
	DefaultMainChainRPCPort = 8545               // The default host port of the main chain's HTTP RPC server
)
...
type Config struct {
	...
	MainChainRPCHost string `toml:",omitempty"`
	MainChainRPCPort int    `toml:",omitempty"`
}
